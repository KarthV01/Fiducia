...
export function CreatorWalletsPage() {
  ...
  return <div className="max-w-5xl">
    ...
    <div className="mb-7 rounded-xl border border-accent-rule bg-accent-soft p-4 text-sm"><div className="font-medium text-ink">A signature proves ownership - it does not move funds.</div><p className="mt-1 text-muted">Payouts never requests a recovery phrase, private key, token approval, or gas payment.</p></div>
